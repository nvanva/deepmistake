...
echo "sample comlete"
cd deepmistake
python run_model.py --do_eval --ckpt_path ../mean_dist_l1ndotn_CE --eval_input_dir ../pairs/combine/sampled_data --eval_output_dir rusemshift_predictions/ --output_dir ../mean_dist_l1ndotn_CE --loss crossentropy_loss --pool_type mean --symmetric true --train_scd 
cd ..
