...
OUTPUT_DIR=xlmr-large..data_train-wic..train_loss-crossentropy_loss..data_ft-${dataset}..ft_loss-${ft_loss}..pool-${pool}..targ_emb-${targ_emb}..hs-${hs}..bn-${batch_norm}..ckpt-${train_ckpt}
